      ...
      try {
        ...
        if (collections.length > 0) {
          const formattedCategories = collections.map((collection) => ({
            ...
            bgColor: collection.bgColor || "bg-gray-100",
          }));
        ...
        console.error(
          "Failed to fetch dynamic categories for CategoryScroll:",
          err
        );

        // Error aaye to default categories hi rahengi
        ...
        <div className="flex overflow-x-auto gap-4 md:gap-8 lg:gap-12 pb-6 pt-6 hide-scrollbar snap-x snap-mandatory lg:justify-center">
          ...
          {Array.isArray(categories) &&
            categories.map((category, index) => (
              ...
              >
                <div
                  className={`relative w-[85px] h-[100px] md:w-[140px] md:h-[180px] lg:w-[160px] lg:h-[200px]
                  ...
                  group-hover:ring-offset-[var(--color-bg)]
