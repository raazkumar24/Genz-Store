    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto pb-24">
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link to="/admin/products" className="flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-600 shadow-sm hover:bg-gray-50 hover:text-gray-900 transition-colors">
            <ArrowLeft size={20} />
          </Link>
          <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {specifications.map((spec, index) => (
                      <div key={index} className="flex items-center gap-3">
                        <input
                          ...
                          className="flex-1 rounded-xl border border-gray-300 bg-gray-50/50 px-4 py-2 text-sm text-gray-900 focus:bg-white focus:border-[var(--color-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--color-primary)] transition-all"
                        />
                        <input
                          type="text"
                          value={spec.value}
        ...
        <div className="fixed bottom-0 left-0 right-0 md:left-[288px] z-20 flex items-center justify-end gap-3 border-t border-gray-200 bg-white/80 backdrop-blur-md px-6 py-4">
