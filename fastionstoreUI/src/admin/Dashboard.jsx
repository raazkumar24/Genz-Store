...
import { Package, ShoppingBag, IndianRupee, ArrowRight, TrendingUp } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const stats = useMemo(() => {
        ...
        const inventoryValue = products?.reduce((acc, curr) => acc + (curr.variants?.[0]?.price || 0), 0) || 0;
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full max-w-6xl mx-auto pb-24">
            ...
            <Card className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between p-8">
                <div>
                    ...
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 md:text-4xl" style={{ fontFamily: 'var(--font-heading)' }}>
                        Dashboard
                    </h2>
                ...
                <div className="mt-4 md:mt-0 shrink-0">
                    <Button to="/admin/products/new" variant="primary" className="flex items-center gap-2" icon={<ArrowRight size={18} />} iconPosition="right">
                        Add New Drop
                    </Button>
                </div>
            </Card>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10">
                ...
                <Card className="group p-6 hover:-translate-y-1 transition-transform">
                    ...
                    <div>
                        ...
                        <h3 className="text-3xl font-bold text-gray-900 mt-1" style={{ fontFamily: 'var(--font-heading)' }}>
                ...
                <Card className="group p-6 hover:-translate-y-1 transition-transform sm:col-span-2 lg:col-span-1">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Est. Revenue</p>
                        <h3 className="text-3xl font-bold text-gray-900 mt-1" style={{ fontFamily: 'var(--font-heading)' }}>
                            ₹{loading ? <span className="animate-pulse">...</span> : stats.revenue.toLocaleString('en-IN')}
                        </h3>
                    </div>
                </Card>
            </div>
                ...
                <div className="flex flex-col gap-4">
                    {loading ? (
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            ...
                                            <Badge variant="secondary" className="px-2 py-0.5 text-[10px]">{product.category || 'Apparel'}</Badge>
                                        </div>
                                    </div>
                                </div>
                                <Button to={`/admin/products/edit/${product._id}`} variant="outline" size="sm" className="shrink-0">
                                    Edit
                                </Button>
                            </div>
                        ))
                        ...
                        <div className="py-12 text-center">
                            <span className="text-4xl inline-block mb-4 text-gray-300">📦</span>
                            <p className="text-sm font-medium text-gray-500">No products found. Start dropping heat!</p>
                        </div>
                    )}
                </div>
            </Card>
