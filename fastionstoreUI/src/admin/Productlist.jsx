...
import { Plus, Edit2, Trash2, Search, PackageOpen, Package } from 'lucide-react';
...
const ProductList = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            addToast("Failed to delete product. Please check API connection.", "error");
        }
    };
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full max-w-6xl mx-auto pb-24">
            ...
            <Card className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-4 md:mt-0">
                    ...
                    <Button to="/admin/products/new" variant="primary" className="flex items-center gap-2 shrink-0">
                        <Plus size={20} />
                        Add Drop
                    </Button>
                </div>
                                ...
                                <tr>
                                    <td colSpan="4" className="px-6 py-16 text-center">
                                        <div className="flex flex-col items-center justify-center gap-4 text-gray-500">
                                            ...
                                            <div>
                                                <p className="text-xl font-bold text-gray-900" style={{ fontFamily: 'var(--font-heading)' }}>Empty Vault</p>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                {/* Variant count */}
                                                <p className="mt-1 text-[10px] text-gray-400">{product.variants?.length || 0} variant(s) · Stock: {totalStock}</p>
                                            </div>
                                        </div>
                                    </td>
