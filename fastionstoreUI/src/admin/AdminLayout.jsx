      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden bg-gray-50 relative min-w-0">
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6 md:px-10 z-10 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h1
              className="text-xl font-bold tracking-tight text-gray-900 hidden md:block"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Admin Dashboard
            </h1>
          ...
          <div className="flex items-center gap-3">
            <NavLink
              to="/"
              className="inline-flex items-center justify-center rounded-lg bg-gray-900 px-5 py-2 text-xs font-semibold text-white transition-colors hover:bg-gray-800"
            >
              View Store
            </NavLink>
          </div>
