            ...
            <Card className="relative z-10 w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 overflow-hidden p-0">
                ...
                <div className="p-8 md:p-12">
                    ...
                    <p className="mt-8 text-center text-sm font-medium text-gray-500">
                        New to the club?{' '}
                        <Link to="/register" className="text-gray-900 font-semibold hover:text-[var(--color-primary)] underline decoration-2 underline-offset-4">
                            Create Account
                        </Link>
                    </p>
                </div>
                    ...
                    <div className="absolute bottom-12 left-12 right-12 text-white">
                        <div className="grid grid-cols-2 gap-6 mb-8">
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-5 rounded-2xl">
                                <h3 className="text-2xl font-black uppercase" style={{ fontFamily: 'var(--font-heading)' }}>Fast</h3>
                                <p className="mt-1 text-sm text-gray-300">Quick checkout & easy tracking.</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-5 rounded-2xl">
                                <h3 className="text-2xl font-black uppercase" style={{ fontFamily: 'var(--font-heading)' }}>Secure</h3>
                                <p className="mt-1 text-sm text-gray-300">Your data is safe with us.</p>
                            </div>
                        </div>
                        <h2 className="text-4xl font-black uppercase tracking-tighter leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                            Style<br />Starts<br />Here.
                        </h2>
                    </div>
                </div>
