...
import { 
  ...
  ShieldCheck, Truck, RotateCcw, Tag, Check 
} from "lucide-react";
  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-screen bg-[var(--color-bg)] flex flex-col items-center justify-center px-4 py-16 text-center">
        ...
        <h1 className="text-3xl font-black text-neutral-900 uppercase" style={{ fontFamily: "var(--font-heading)" }}>
          Your Cart is Empty
        </h1>
        <p className="mt-2 text-xs sm:text-sm text-neutral-500 font-medium max-w-sm">
          You haven't added any streetwear drops to your bag yet. Flex your fit and start exploring!
        </p>
        <Button to="/" variant="primary" size="lg" className="mt-6 flex items-center gap-2 rounded-2xl" icon={<ArrowRight size={16} />} iconPosition="right">
          Explore Drops
        </Button>
      </div>
    );
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px] items-start">
              ...
              return (
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <Link
                      to={productUrl}
                      className="h-22 w-22 sm:h-28 sm:w-28 shrink-0 overflow-hidden rounded-2xl border border-neutral-200 bg-[#f8f8f7] hover:opacity-90 transition-opacity"
                    >
                      {item.image ? (
                        <img
                          src={item.image}
          ...
          <div className="lg:sticky lg:top-24 space-y-4">
            ...
            <div className="rounded-3xl bg-white p-5 border border-neutral-200/80 shadow-2xs">
              ...
              {appliedCoupon && (
                <div className="mt-2.5 flex items-center justify-between rounded-xl bg-emerald-50 px-3 py-1.5 text-xs text-emerald-800 font-bold border border-emerald-200">
                  ...
                  <button
                    onClick={() => { setDiscountPercent(0); setAppliedCoupon(""); }}
            ...
            <div className="rounded-3xl bg-white p-6 border border-neutral-200/80 shadow-2xs">
              <h2 className="text-base font-black text-neutral-900 uppercase tracking-wide mb-4 pb-3 border-b border-neutral-100" style={{ fontFamily: "var(--font-heading)" }}>
                Order Summary
              </h2>
              ...
              <div className="space-y-2.5 text-xs font-semibold">
                ...
                <div className="border-t border-neutral-100 pt-3 flex justify-between text-base font-black text-neutral-900">
                  ...
                  <span className="text-lg text-[var(--color-primary)]">₹{finalTotal.toLocaleString()}</span>
                </div>
              </div>
              ...
              <Button
                ...
                iconPosition="right"
                onClick={() => addToast("Proceeding to secure checkout...", "info")}
              >
                Proceed to Checkout
              </Button>
